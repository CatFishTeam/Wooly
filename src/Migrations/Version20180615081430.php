 ...
 */
final class Version20180615081430 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE level (id INT AUTO_INCREMENT NOT NULL, creator_id_id INT NOT NULL, data JSON NOT NULL, best JSON DEFAULT NULL, thumbnail VARCHAR(255) NOT NULL, status INT NOT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, played INT NOT NULL, finished INT DEFAULT NULL, INDEX IDX_9AEACC13F05788E9 (creator_id_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
